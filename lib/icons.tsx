...
/** Arrow right (CTA) */
export function ArrowRightIcon(p: { className?: string; size?: number }) {
  return (
...
/** Download arrow (export / save) */
export function DownloadIcon(p: { className?: string; size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className={p.className} {...sizeProps(p.size)}>
...
export function InstagramIcon(p: { className?: string; size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={p.className} {...sizeProps(p.size)}>
...
/** X / Twitter */
export function TwitterIcon(p: { className?: string; size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={p.className} {...sizeProps(p.size)}>
...
/** YouTube (play) */
export function YoutubeIcon(p: { className?: string; size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={p.className} {...sizeProps(p.size)}>
...
/** LinkedIn */
export function LinkedInIcon(p: { className?: string; size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={p.className} {...sizeProps(p.size)}>
...
/** Briefcase (logo accent for LORO) */
export function BriefcaseIcon(p: { className?: string; size?: number }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={p.className} {...sizeProps(p.size)}>

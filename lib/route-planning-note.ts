...
export const ROUTE_PLANNING_NOTE =
  'Each night the ERP import matches customers to the rep with the same sales code, then books weekday visits for the next four weeks. Each day gets up to 10 nearby clients, kept together as one group. Clients who already have a visit from today through that window stay as they are. Clients without a map address are skipped. All tasks includes those upcoming days. Open Routes and pick the day the visits were planned.';

...
import type { DataQualitySummary, MapMarkerBuckets } from './types';
...
export function geolocatedMarkers(markers: MapMarkerBase[]): Array<
  MapMarkerBase & { lat: number; lng: number }
> {

...
export const filterToolbarSearchInputClassName =
  "h-9 w-full min-w-0 border-border bg-background text-foreground placeholder:text-xs placeholder:italic placeholder:text-muted-foreground focus:outline-none focus:ring-0 focus-visible:ring-0"

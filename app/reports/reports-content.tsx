...
import { useTokenReady, useSessionSync, useCheckIns } from '@/api/hooks';
...
/** Visits report: visit charts with date range filter. Admin-only. Uses visits-store for filter state. */
